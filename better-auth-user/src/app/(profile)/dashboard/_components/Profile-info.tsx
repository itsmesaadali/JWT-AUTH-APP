...
const ProfileInfo = ({ user }: { user: { name: string; email: string } }) => {
  ...
  const {
    ...
    formState: { isSubmitting: isSubmittingName, isDirty: isDirtyName, errors: errorsName },
    reset: resetName,
  ...
  const {
    ...
    formState: { isSubmitting: isSubmittingEmail, isDirty: isDirtyEmail, errors: errorsEmail },
    reset: resetEmail,
    ...
    <TabsContent value="profile" className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-4">
          <form onSubmit={handleSubmitName(onSubmitName)} className="space-y-2">
            ...
            <div className="flex gap-2">
              <div className="flex flex-col gap-1 flex-1">
                ...
                {errorsName.name && (
                  <p className="text-sm text-red-500">{errorsName.name.message}</p>
                )}
              </div>
              <Button type="submit" disabled={!isDirtyName || isSubmittingName}>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <form onSubmit={handleSubmitEmail(onSubmitEmail)} className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <Button type="submit" disabled={!isDirtyEmail || isSubmittingEmail}>
